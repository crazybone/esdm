...
import { TextField, Button, Select, MenuItem, Grid, InputLabel, OutlinedInput } from '@mui/material';

const BannerContainer = ({ section, setData }) =>  {
  ...
  return (
    <>
    <InputLabel id="select-label">Banner type</InputLabel>
      <Select value={bannerType} labelid="select-label" input={<OutlinedInput label="Banner type" />} onChange={(e) => setBannerType(e.target.value)} fullWidth>
